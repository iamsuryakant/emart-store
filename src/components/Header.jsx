        ...
        <nav className='container mx-auto px-6 py-5'>
          <div className='flex justify-between items-center'>
            ...
            <div className='flex items-center space-x-10'>
              <a
                href='#'
                className='relative text-gray-900 font-medium hover:text-red-600'
              >
                Products
              ...
              <div className='relative' onClick={handleShowCart}>
                ...
                >
                  ...
                  {cartItems && cartItems.length > 0 && (
                    <span className='text-xs font-semibold text-white bg-red-600 rounded-full h-5 w-5 flex items-center justify-center relative -top-3 -left-2'>
                      {cartItems.length}
                    </span>
                  )}
                </a>
